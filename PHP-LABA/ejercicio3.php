...
//ORDENAR ARRAY DE DOS DIMENSIONES A LOS VALORES DE ACUERDO AL ORDEN ALFABETICO ASCENDENTE (A ES PARA ORDENAR LOS VALORES)
asort($electrodomesticos);
echo "<pre>";
var_dump($electrodomesticos);
echo "</pre>";
//ORDENAR ARRAY DE DOS DIMENSIONES A LOS VALORES DE ACUERDO AL ORDEN ALFABETICO DE MANERA DECENDENTE (A ES PARA ORDENAR LOS VALORES)
